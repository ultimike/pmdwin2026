...
namespace Drupal\drupaleasy_repositories\Attribute;

use Drupal\Component\Plugin\Attribute\AttributeBase;
use Drupal\Core\StringTranslation\TranslatableMarkup;

/**
 * The drupaleasy_repositories attribute.
 */
#[\Attribute(\Attribute::TARGET_CLASS)]
final class DrupaleasyRepositories extends AttributeBase {

  /**
   * Constructs a new DrupaleasyRepositories instance.
   *
   * @param string $id
